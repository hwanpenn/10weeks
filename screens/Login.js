    ...
    render() {
        ...
        return (
            <View style={styles.loginContainer}>
                <View style={{marginTop: Platform.OS === "ios" ? 43 : 34,flexDirection : "row",justifyContent : "flex-start",height: Platform.OS === "ios" ? 43 : 30}}>
                    {/*<View style={{*/}
                    ...
                    {/*}}>*/}
                        ...
                        <View style={{marginLeft: Platform.OS === "ios" ? 12 : 11,width: 100,  }} >
                ...
                <View style={{marginTop: Platform.OS === "ios" ? 0 : 0,flexDirection : "row",justifyContent : "center",height : Platform.OS === "ios" ? 71.5 : 100}}>
                        ...
                        <View style={{backgroundColor:"#FFFFFF", border:1,width:1 ,height:28,marginTop:25}} />
                    <Text onPress={() => {this._handleIsCode()}}  style={{padding:25,textAlign:'center',fontSize:27,color : this.state.isClick === "isCode" ? "#fff" : "#868686",marginLeft:0,marginTop:Platform.OS === "ios" ? 0 : 0}} >验证码登陆</Text>
                </View>
...
const styles = StyleSheet.create({
    ...
    buttonContainer1: {
        zIndex: 9999,
    width: Platform.OS === "ios" ? 108.5 : 108.5,
